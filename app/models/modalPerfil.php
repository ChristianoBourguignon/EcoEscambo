            ...
            <div class="modal-body">
                ...
                <div class="tab-content" id="loginTabContent">
                    ...
                    <div class="tab-pane fade p-4" id="register" role="tabpanel">
                        <form id="registerForm" action="<?= BASE ?>/criarConta" method="POST">
                            <div class="mb-3">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function validarCadastro() {
            ...
            const senhaValida = validarSenhaComplexa(senhaInput.value);
            ...
            // Senha
            senhaInput.classList.toggle("is-invalid", !senhaValida);
            senhaFeedback.style.display = senhaValida ? "none" : "block";

            // Confirmação de senha
            confirmInput.classList.toggle("is-invalid", !senhasIguais);
